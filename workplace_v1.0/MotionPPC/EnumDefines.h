...
typedef enum tagParamType
{
	...
	LIMIT_TYPE = 31,                        //限幅
	FIR_INDEPENDENT_DXMOVE_TYPE = 41,         //dx轨迹时，独立模式FIR参数
	FIR_FOLLOW_DXMOVE_TYPE = 42,             //dx轨迹时，跟随模式FIR参数
	FIR_INDEPENDENT_DYMOVE_TYPE = 51,         //dy轨迹时，独立模式FIR参数
	FIR_FOLLOW_DYMOVE_TYPE = 52,             //dy轨迹时，跟随模式FIR参数
