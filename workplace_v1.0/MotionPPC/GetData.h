...
typedef enum
{
	...
	fineAxisError_TY=29,
	fineAxisSimulateActPos_DX=30,
	fineAxisSimulateSetPoint_DX=31,
	fineAxisSimulateError_DX=32,
	fineAxisSimulateActPos_DY=33,
	fineAxisSimulateSetPoint_DY=34,
	fineAxisSimulateError_DY=35,
	fineAxisSimulateActPos_TZ=36,
	fineAxisSimulateSetPoint_TZ=37,
	fineAxisSimulateError_TZ=38,
	fineAxisSimulateActPos_DZ=39,
	fineAxisSimulateSetPoint_DZ=40,
	fineAxisSimulateError_DZ=41,
	fineAxisSimulateActPos_TX=42,
	fineAxisSimulateSetPoint_TX=43,
	fineAxisSimulateError_TX=44,
	fineAxisSimulateActPos_TY=45,
	fineAxisSimulateSetPoint_TY=46,
	fineAxisSimulateError_TY=47,
